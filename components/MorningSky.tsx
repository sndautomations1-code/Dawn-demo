...
const OUTLINES: Record<string, { d: string; opacity: number }> = {
  a: { d: "M18 92 Q40 58 82 60 Q102 26 150 32 Q196 26 218 58 Q258 56 284 90", opacity: 0.1 },
  b: { d: "M24 96 Q60 52 108 58 Q138 30 178 40 Q228 36 276 88", opacity: 0.09 },
  c: { d: "M12 90 Q48 64 92 62 Q118 34 162 38 Q206 30 234 60 Q268 62 290 92", opacity: 0.11 },
};

const CLOUD_FILL = (o1: number, o2: number, o3: number) =>
  [
...
const CLOUDS = [
  { left: "60%", top: "8%", width: "min(13vw, 12rem)", blur: 26, fill: CLOUD_FILL(0.5, 0.5, 0.46), outline: "a", drift: "26px", dur: "46s", delay: "-12s" },
  { left: "44%", top: "6%", width: "min(11vw, 10rem)", blur: 28, fill: CLOUD_FILL(0.46, 0.5, 0.44), outline: "b", drift: "-22px", dur: "58s", delay: "-30s" },
  { left: "42%", top: "56%", width: "min(19vw, 17rem)", blur: 38, fill: CLOUD_FILL(0.44, 0.48, 0.42), outline: "c", drift: "30px", dur: "66s", delay: "-8s" },
  { left: "67%", top: "80%", width: "min(30vw, 27rem)", blur: 52, fill: CLOUD_FILL(0.38, 0.42, 0.36), drift: "-34px", dur: "74s", delay: "-40s" },
  { left: "33%", top: "83%", width: "min(26vw, 24rem)", blur: 56, fill: CLOUD_FILL(0.36, 0.4, 0.34), drift: "28px", dur: "82s", delay: "-20s" },
] as const;
